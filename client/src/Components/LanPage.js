  ...
  return (
    <div className="LanPage">
      <div className="Info  animate__animated  animate__fadeInLeft animate__delay-0.15s">
        ...
        <p>
          نحن رواد في تحقيق السعادة الصحيه نقدم لكم فرص للتوجه نحو اسلوب حياه
          متوازن يجمع بين الصحه والرياضه نعمل خصيصا على تعزيز صحتك ولايقتك
          البدنيه بتقديم التشجيع و الدعم الشامل للنساء اثناء فتره حملهن وبعدها
          بالإضافه الى مرضى الامراض المزمنه على ممارسه النشاط الرياضي بطريقه
          موجهه آمنه وفعالة من خلال توفير مجموعه خدمات مدروسة من طرف فريق متكامل
        </p>
